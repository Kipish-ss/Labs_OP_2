...
const Numeral_16 Numeral_16::operator +(const Numeral_16& obj) {
    Numeral_16 temp;
    temp.num_16_str = Numeral_16(stoi(num_16_str, nullptr, 16) + stoi(obj.num_16_str, nullptr, 16)).num_16_str;
    return temp;
}

const Numeral_16 Numeral_16::operator +=(const Numeral_16& obj) {
    num_16_str = Numeral_16(stoi(num_16_str, nullptr, 16) + stoi(obj.num_16_str, nullptr, 16)).num_16_str;
    return *this;
}
