...
class Car:
    def __init__(self, model: str, release_date: str, sell_date: str):
        self.model = model
        self.release_date = release_date
        self.sell_date = sell_date

    def __str__(self):
        info = f'Car model: {self.model}, release date: {self.release_date}, sell start date: {self.sell_date}'
        return info
...
def create_fist_file(file_name: str, n: int, mode: str):
    ...
    for i in range(n):
        ...
        release_date = input('Enter the date when this car was released in such format '
                             'MM.YYYY : ')
        sell_date = input('Enter the sale start date in such format MM.YYYY : ')
        car = Car(model, release_date, sell_date)
        car_list.append(car)
